    ...
    if (t.console = t.console || {
        ...
        var i = {
                ...
                btnTpl: {
                    ...
                    arrowLeft: '<button data-fancybox-prev class="fancybox-button fancybox-button--arrow_left" title="{{PREV}}"><div><svg width="24" height="40" viewBox="0 0 24 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.42021 18.0198L18.6196 0.820972C19.7137 -0.273648 21.4876 -0.273647 22.5811 0.820972C23.6748 1.91462 23.6748 3.6884 22.5811 4.78196L7.36232 20.0003L22.5807 35.2181C23.6743 36.3122 23.6743 38.0858 22.5807 39.1794C21.487 40.2735 19.7133 40.2735 18.6192 39.1794L1.41976 21.9803C0.872938 21.4333 0.599836 20.717 0.599836 20.0004C0.599836 19.2834 0.87347 18.5666 1.42021 18.0198Z" fill="white"/></svg></div></button>',
                    arrowRight: '<button data-fancybox-next class="fancybox-button fancybox-button--arrow_right" title="{{NEXT}}"><div><svg width="24" height="40" viewBox="0 0 24 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22.5798 21.9802L5.3804 39.179C4.28631 40.2736 2.51243 40.2736 1.41887 39.179C0.325221 38.0854 0.325221 36.3116 1.41887 35.218L16.6377 19.9997L1.41931 4.78191C0.325663 3.68782 0.325663 1.91421 1.41931 0.820565C2.51296 -0.273522 4.28675 -0.273522 5.38084 0.820565L22.5802 18.0197C23.1271 18.5667 23.4002 19.283 23.4002 19.9996C23.4002 20.7166 23.1265 21.4334 22.5798 21.9802Z" fill="white"/></svg></div></button>',
                },
                parentEl: "body",
                hideScrollbar: !0,
                autoFocus: !0,
